![A Convolutional Transformer for Character-Level Neural Machine Translation](./README/convtransformer-fig-new.png)

# A Convolutional Transformer for Character-Level Neural Machine Translation 

This repository stores the code for the paper [Character-Level Translation with Self-attention](https://openreview.net/forum?id=BWlCpme3TS)
...
We train our models with 4 NVIDIA 1080x GPUs.  The models are trained with [Adam](https://arxiv.org/abs/1412.6980) optimizer and an adaptive learning rate adjusting method with warm-up learning rate initials. 
